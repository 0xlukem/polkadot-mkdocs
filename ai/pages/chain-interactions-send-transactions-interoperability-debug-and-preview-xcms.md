...
- [Chopsticks](/polkadot-mkdocs/reference/tools/chopsticks/){target=\_blank} installed
...
5. Install the required Polkadot packages:
    ...
    ```bash
    npm install polkadot-api@1.23.2 @polkadot-labs/hdkd@0.0.26 @polkadot-labs/hdkd-helpers@0.0.27
    ```
