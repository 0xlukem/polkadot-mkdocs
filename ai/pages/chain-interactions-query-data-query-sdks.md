...
=== "Subxt"
    ...
    [Subxt](/polkadot-mkdocs/reference/tools/subxt/){target=\_blank} is a Rust library that provides compile-time type safety through code generation from chain metadata.
...
- <span class="badge guide">Guide</span> **Runtime API Calls**
    ...
    [:octicons-arrow-right-24: Get Started](/polkadot-mkdocs/chain-interactions/query-data/runtime-api-calls/)
