...
- A basic understanding of [XCM](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank}.
...
```bash
npm install @paraspell/sdk-pjs@12.3.0 @polkadot/api@16.5.4 @polkadot/types@16.5.4 ethers@6.16.0
```
