...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-for-eth-devs-accounts.md
...
- Word Count: 1675; Token Estimate: 2602
...
- [Polkadot native account IDs (32 bytes)](/polkadot-mkdocs/reference/parachains/accounts/){target=\_blank}
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-explorers.md
...
- Word Count: 170; Token Estimate: 262
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-blocks-transactions-fees-blocks.md
...
- Word Count: 912; Token Estimate: 1401
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/chain-interactions-send-transactions-calculate-transaction-fees.md
...
- Word Count: 1155; Token Estimate: 2118
...
[Polkadot-API](/polkadot-mkdocs/reference/tools/papi){target=\_blank} is the modern, recommended library for building TypeScript applications with type safety and light client support.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-chain-data.md
...
- Word Count: 2220; Token Estimate: 3785
...
Different extrinsic versions can have varying formats, especially when considering [signed transactions](/polkadot-mkdocs/reference/parachains/blocks-transactions-fees/transactions/#signed-transactions){target=\_blank}. 
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-connect.md
...
- Word Count: 567; Token Estimate: 1028
...
For more information about how to connect to Polkadot Hub, please check the [Wallets for Polkadot Hub](/polkadot-mkdocs/smart-contracts/integrations/wallets/){target=\_blank} guide.

!!! warning "Account Mapping"
    If you are using a native Polkadot account (32-byte format) that was created with a Polkadot/Substrate keypair (Ed25519/Sr25519) rather than an Ethereum-compatible keypair (secp256k1), you'll need to map your account to enable Ethereum compatibility. See the [Account Mapping](/polkadot-mkdocs/smart-contracts/for-eth-devs/accounts/#account-mapping-for-native-polkadot-accounts){target=\_blank} section for more details.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-for-eth-devs-contract-deployment.md
...
- Word Count: 766; Token Estimate: 1175
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/chain-interactions-accounts-create-account.md
...
- Word Count: 909; Token Estimate: 1694
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-cryptography.md
...
- Word Count: 1293; Token Estimate: 1799
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-data-encoding.md
...
- Word Count: 1305; Token Estimate: 3191
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-.deploy-basic-pvm.md
...
npm init -y
npm install ethers @parity/resolc@0.6.0
```
...
![](/polkadot-mkdocs/images/smart-contracts/cookbook/smart-contracts/deploy-basic/deploy-basic-pvm/deploy-basic-pvm-01.webp)
...
1. To compile your contract:
    ...
    ![](/polkadot-mkdocs/images/smart-contracts/cookbook/smart-contracts/deploy-basic/deploy-basic-pvm/deploy-basic-pvm-02.webp)
...
4. Approve the transaction in your MetaMask wallet.
    ...
    ![](/polkadot-mkdocs/images/smart-contracts/cookbook/smart-contracts/deploy-basic/deploy-basic-pvm/deploy-basic-pvm-03.webp)
...
- Deploy an ERC-20 token on Polkadot Hub, either using the [Deploy an ERC-20](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-erc20) guide or the [Deploy an ERC-20 to Polkadot Hub](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-erc20) guide.
- Deploy an NFT on Polkadot Hub, either using the [Deploy an NFT](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-nft) guide or the [Deploy an NFT to Polkadot Hub](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-nft) guide.
- Check out in details each [development environment](/polkadot-mkdocs/smart-contracts/dev-environments/).
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-basic-.foundry.md
...
- Word Count: 361; Token Estimate: 684
...
- Basic understanding of Solidity programming.
- Test tokens for gas fees (available from the [Polkadot faucet](https://faucet.polkadot.io/){target=\_blank}). See the [step-by-step instructions](/polkadot-mkdocs/smart-contracts/faucet/#get-test-tokens){target=\_blank}.
- A wallet with a private key for signing transactions.
...
-   <span class="badge guide">Guide</span> __Verify Your Contract__
    ...
    [:octicons-arrow-right-24: Get Started](/polkadot-mkdocs/smart-contracts/dev-environments/foundry/verify-a-contract/)
...
-   <span class="badge guide">Guide</span> __Deploy an ERC-20__
    ...
    [:octicons-arrow-right-24: Get Started](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-erc20/foundry/)
...
-   <span class="badge guide">Guide</span> __Deploy an NFT__
    ...
    [:octicons-arrow-right-24: Get Started](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-nft/foundry/)
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-basic-basic-hardhat.md
...
- Word Count: 799; Token Estimate: 1491
...
- Test tokens for gas fees, available from the [Polkadot faucet](https://faucet.polkadot.io/){target=\_blank}. See [Get Test Tokens](/polkadot-mkdocs/smart-contracts/faucet/#get-test-tokens){target=\_blank} for a guide to using the faucet.
- A wallet with a private key for signing transactions.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-basic-basic-remix.md
...
- Word Count: 561; Token Estimate: 917
...
- A basic understanding of [Solidity](https://www.soliditylang.org/){target=\_blank} programming.
- An EVM-compatible [wallet](/polkadot-mkdocs/smart-contracts/connect/){target=\_blank} connected to Polkadot Hub. This example utilizes [MetaMask](https://metamask.io/){target=\_blank}.
- Test tokens for gas fees, available from the [Polkadot faucet](https://faucet.polkadot.io/){target=\_blank}. See [Get Test Tokens](/polkadot-mkdocs/smart-contracts/faucet/#get-test-tokens){target=\_blank} for a guide to using the faucet.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-erc20-erc20-hardhat.md
...
- Word Count: 1114; Token Estimate: 2133
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-erc20-erc20-remix.md
...
- Word Count: 874; Token Estimate: 1467
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-nft-nft-remix.md
...
- Word Count: 688; Token Estimate: 1204
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-nft-nft-hardhat.md
...
- Word Count: 978; Token Estimate: 1864
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-smart-contracts-deploy-nft-.foundry.md
...
- Word Count: 444; Token Estimate: 865
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-libraries-ethers-js.md
...
- Word Count: 2378; Token Estimate: 4676
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-libraries-web3-js.md
...
- Word Count: 2224; Token Estimate: 4569

# Web3.js

!!! warning
    Web3.js has been [sunset](https://blog.chainsafe.io/web3-js-sunset/){target=\_blank}. You can find guides on using [Ethers.js](/polkadot-mkdocs/smart-contracts/libraries/ethers-js/){target=\_blank} and [viem](/polkadot-mkdocs/smart-contracts/libraries/viem/){target=\_blank} in the Libraries section. 
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-for-eth-devs-dual-vm-stack.md
...
- Word Count: 463; Token Estimate: 701
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-precompiles-eth-native.md
...
- Word Count: 541; Token Estimate: 1215
...
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------: | :---------------------------------------------------------------------------------------------: |
|  [ECRecover](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/ecrecover.rs){target=\_blank}   |        0x01         |                       Recovers the public key associated with a signature                       |
|     [Sha256](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/sha256.rs){target=\_blank}      |        0x02         |                              Implements the SHA-256 hash function                               |
|  [Ripemd160](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/ripemd160.rs){target=\_blank}   |        0x03         |                             Implements the RIPEMD-160 hash function                             |
|   [Identity](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/identity.rs){target=\_blank}    |        0x04         |                          Data copy function (returns input as output)                           |
|     [Modexp](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/modexp.rs){target=\_blank}      |        0x05         |                                     Modular exponentiation                                      |
|   [Bn128Add](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/bn128.rs#L31){target=\_blank}   |        0x06         |    Addition on the [alt_bn128 curve](https://eips.ethereum.org/EIPS/eip-196){target=\_blank}    |
|   [Bn128Mul](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/bn128.rs#L59){target=\_blank}   |        0x07         | Multiplication on the [alt_bn128 curve](https://eips.ethereum.org/EIPS/eip-196){target=\_blank} |
| [Bn128Pairing](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/bn128.rs#L87){target=\_blank} |        0x08         |                              Pairing check on the alt_bn128 curve                               |
|    [Blake2F](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/revive/src/precompiles/builtin/blake2f.rs){target=\_blank}     |        0x09         |                                  Blake2 compression function F                                  |
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-for-eth-devs-evm-vs-pvm.md
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-get-started.md
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-get-started.md
...
- Word Count: 694; Token Estimate: 2185
...
| [Explore Transactions](/polkadot-mkdocs/smart-contracts/explorers/) |        Subscan        | Inspect transactions, logs, token transfers, and contract state |
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-interoperability-get-started.md
...
- Word Count: 979; Token Estimate: 1514
...
- **[BuyExecution](https://github.com/polkadot-fellows/xcm-format?tab=readme-ov-file#buyexecution){target=\_blank}**: Allocates fees to cover the execution [weight](/polkadot-mkdocs/reference/glossary/#weight){target=\_blank} of the XCM instructions.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-faucet.md
...
- Word Count: 277; Token Estimate: 383
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-glossary.md
...
- Word Count: 3612; Token Estimate: 5337
...
For detailed information about the consensus strategies of the [Polkadot](#polkadot) network, see the [Polkadot Consensus](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/){target=\_blank} blog series.
...
Many tools in the Polkadot SDK ecosystem, such as [`subkey`](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/bin/utils/subkey){target=\_blank}, allow you to implicitly specify an account using a derivation path such as `//Alice`.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-install-polkadot-sdk.md
...
- Word Count: 3213; Token Estimate: 5099
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-precompiles-storage.md
...
- Word Count: 1368; Token Estimate: 2518
...
To interact with the Storage precompile in [Remix IDE](/polkadot-mkdocs/smart-contracts/dev-environments/remix/){target=\_blank}:
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/.ai-pages-smart-contracts-precompiles-system.md
- Canonical (HTML): https://docs.polkadot.com/.ai/pages/smart-contracts-precompiles-system/
...
- Word Count: 1612; Token Estimate: 2866
...
To interact with the System precompile in the [Remix IDE](/polkadot-mkdocs/smart-contracts/dev-environments/remix/){target=\_blank}:
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-precompiles-system.md
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-precompiles-xcm.md
...
- Word Count: 1443; Token Estimate: 2337

# XCM Precompile

## Introduction

The [XCM (Cross-Consensus Message)](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank} precompile enables Polkadot Hub developers to access XCM functionality directly from their smart contracts using a Solidity interface.
...
This guide demonstrates how to interact with the XCM precompile through Solidity smart contracts using [Remix IDE](/polkadot-mkdocs/smart-contracts/dev-environments/remix/){target=\_blank}.
...
All XCM messages must be encoded using the [SCALE codec](/polkadot-mkdocs/reference/parachains/data-encoding/#data-encoding){target=\_blank}, Polkadot's standard serialization format.
...
To interact with the XCM precompile, you can use the precompile interface directly in [Remix IDE](/polkadot-mkdocs/smart-contracts/dev-environments/remix/){target=\_blank}:
...
Head to the Polkadot Hub TestNet and start playing around with the precompile using [Hardhat](/polkadot-mkdocs/smart-contracts/dev-environments/hardhat/){target=\_blank}.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-interoperability.md
...
- Word Count: 589; Token Estimate: 783
...
For further information about XCM, check the [Get Started with XCM](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank} article.
...
For more information about bridges in the Polkadot ecosystem, see the [Bridge Hub](/polkadot-mkdocs/reference/polkadot-hub/bridging/){target=\_blank} guide.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-for-eth-devs-json-rpc-apis.md
...
- Word Count: 3763; Token Estimate: 9439
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-dev-environments-local-dev-node.md
...
- Word Count: 1409; Token Estimate: 2433
...
- Completed the [Install Polkadot SDK Dependencies](/polkadot-mkdocs/parachains/install-polkadot-sdk/){target=\_blank} guide and successfully installed [Rust](https://rust-lang.org/){target=\_blank} and the required packages to set up your development environment.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-for-eth-devs-.migration.md
...
- Word Count: 793; Token Estimate: 1312
...
For more information on gas costs, see the [Gas Model](/polkadot-mkdocs/smart-contracts/for-eth-devs/gas-model/){target=\_blank} page.
...
- **Development frameworks**: [Hardhat](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-basic/basic-hardhat/){target=\_blank}, [Remix](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-basic/basic-remix/){target=\_blank}
- **Libraries**: [Ethers.js](/polkadot-mkdocs/smart-contracts/libraries/ethers-js/){target=\_blank}, [Web3.js](/polkadot-mkdocs/smart-contracts/libraries/web3-js/){target=\_blank}, [viem](/polkadot-mkdocs/smart-contracts/libraries/viem/){target=\_blank}
...
- Test thoroughly on [TestNet](/polkadot-mkdocs/smart-contracts/connect/#__tabbed_1_1){target=\_blank} before mainnet deployment.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-networks.md
...
- Word Count: 1111; Token Estimate: 1475
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-node-and-runtime.md
...
- Word Count: 633; Token Estimate: 931
...
This separation gives the [Polkadot relay chain](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/relay-chain/){target=\_blank} and all connected [parachains](/polkadot-mkdocs/reference/parachains/){target=\_blank} an evolutionary advantage over other blockchain platforms.
...
The client and runtime communicate exclusively using [SCALE-encoded](/polkadot-mkdocs/reference/parachains/data-encoding/){target=\_blank} communication. This ensures efficient and compact data exchange between the two components.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-governance.md
...
- Word Count: 1018; Token Estimate: 1614
...
- **[Democracy pallet](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/democracy/src){target=\_blank}**: Handles administration of general stakeholder voting.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime.md
...
- Word Count: 1119; Token Estimate: 1871

# Customize Your Runtime

## Introduction

A blockchain runtime is more than just a fixed set of rules—it's a dynamic foundation that you can shape to match your specific needs. With Polkadot SDK's [FRAME (Framework for Runtime Aggregation of Modularized Entities)](/polkadot-mkdocs/reference/glossary/#frame-framework-for-runtime-aggregation-of-modularized-entities){target=\_blank}, customizing your runtime is straightforward and modular. Instead of building everything from scratch, you combine pre-built pallets with your own custom logic to create a runtime suited to your blockchain's purpose.
...
![](/polkadot-mkdocs/images/parachains/customize-runtime/index/frame-overview-02.webp){ style="background:white" }
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-consensus-and-security-relay-chain.md
...
- Word Count: 1787; Token Estimate: 2607

# Overview

## Introduction

Polkadot is a next-generation blockchain protocol designed to support a multi-chain future by enabling secure communication and interoperability between different blockchains. Built as a Layer-0 protocol, Polkadot introduces innovations like application-specific Layer-1 chains ([parachains](/polkadot-mkdocs/reference/parachains/){targe=\_blank}), shared security through [Nominated Proof of Stake (NPoS)](/polkadot-mkdocs/reference/glossary/#nominated-proof-of-stake-npos){target=\_blank}, and cross-chain interactions via its native [Cross-Consensus Messaging Format (XCM)](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank}.
...
- **Shared security and scalability**: L1 chains connected to Polkadot benefit from its [Nominated Proof of Stake (NPoS)](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/#nominated-proof-of-stake){target=\_blank} system, providing security out-of-the-box without the need to bootstrap their own.
...
- **Rapid L1 development**: The [Polkadot SDK](/polkadot-mkdocs/reference/parachains/){target=\_blank} allows fast, flexible creation and deployment of Layer-1 chains.
...
![](/polkadot-mkdocs/images/reference/polkadot-hub/consensus-and-security/relay-chain/relay-chain-01.webp){ style="background:white" }
...
The [Cross-Consensus Messaging Format (XCM)](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank} allows parachains to exchange messages freely, leveraging the chain's security for trust-free communication.
...
Historically, obtaining core slots on Polkadot chain relied upon crowdloans and auctions. Chain cores were leased through auctions for three-month periods, up to a maximum of two years. Crowdloans enabled users to securely lend funds to teams for lease deposits in exchange for pre-sale tokens, which is the only way to access slots on Polkadot 1.0. Auctions are now deprecated in favor of [coretime](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/agile-coretime/){target=\_blank}.

Additionally, the chain handles [staking](https://wiki.polkadot.com/learn/learn-staking/){target=\_blank}, [accounts](/polkadot-mkdocs/reference/parachains/accounts/){target=\_blank}, balances, and [governance](/polkadot-mkdocs/reference/governance/){target=\_blank}.

#### Agile Coretime

The new and more efficient way of obtaining core on Polkadot is to go through the process of purchasing coretime.

[Agile coretime](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/agile-coretime/){target=\_blank} improves the efficient use of Polkadot's network resources and offers economic flexibility for developers, extending Polkadot's capabilities far beyond the original vision outlined in the [whitepaper](https://assets.polkadot.network/Polkadot-whitepaper.pdf){target=\_blank}..
...
- **On-chain treasury and governance**: Known as [OpenGov](/polkadot-mkdocs/reference/governance/){target=\_blank}, this system allows every decision to be made through public referenda, enabling any token holder to cast a vote.
...
Delegating these responsibilities to [system chains](/polkadot-mkdocs/reference/polkadot-hub/#core-components){target=\_blank} could enhance flexibility and allow the relay chain to concentrate on providing shared security and interoperability.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains.md
...
- Word Count: 1041; Token Estimate: 1786
...
FRAME provides modular components called [pallets](/polkadot-mkdocs/reference/glossary#pallet){target=\_blank} that you can compose to build your parachain's runtime. Each pallet provides specific functionality that you can customize and configure for your needs. This modular approach allows you to quickly assemble complex functionality without writing everything from scratch.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub.md
...
- Word Count: 840; Token Estimate: 1285
...
- <span class="badge learn">Learn</span> **Consensus & Security**
    ...
    [:octicons-arrow-right-24: Reference](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/)
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-accounts.md
...
- Word Count: 4198; Token Estimate: 6517
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/chain-interactions-accounts-query-accounts.md
...
- Word Count: 2760; Token Estimate: 6346
...
- **[Polkadot API (PAPI)](/polkadot-mkdocs/reference/tools/papi/){target=\_blank}**: Modern TypeScript library with type-safe APIs
- **[Polkadot.js API](/polkadot-mkdocs/reference/tools/polkadot-js-api/){target=\_blank}**: Comprehensive JavaScript library (maintenance mode)
- **[Dedot](/polkadot-mkdocs/reference/tools/dedot/){target=\_blank}**: Lightweight TypeScript library optimized for performance
- **[Python Substrate Interface](/polkadot-mkdocs/reference/tools/py-substrate-interface/){target=\_blank}**: Python library for Substrate chains
- **[Subxt](/polkadot-mkdocs/reference/tools/subxt/){target=\_blank}**: Rust library with compile-time type safety
...
=== "Polkadot.js"
    ...
    !!! warning "Maintenance Mode Only"
        The Polkadot.js API is no longer actively developed. New projects should use [PAPI](/polkadot-mkdocs/reference/tools/papi/){target=\_blank} or [Dedot](/polkadot-mkdocs/reference/tools/dedot/){target=\_blank} as actively maintained alternatives.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-randomness.md
...
- Word Count: 1011; Token Estimate: 1402
...
Polkadot's VRF is similar to the one used in [**Ouroboros Praos**](https://eprint.iacr.org/2017/573.pdf){target=\_blank}, which secures randomness for block production in systems like [BABE](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/#block-production-babe){target=\_blank} (Polkadot’s block production mechanism). 
...
To verify resolution of this issue and that Polkadot block times remain near constant-time, see the [PoS Consensus](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/){target=\_blank} page of this documentation.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/chain-interactions-token-operations-register-local-asset.md
...
- Word Count: 1020; Token Estimate: 1552

# Register a Local Asset on Polkadot Hub

## Introduction

As detailed in the [Assets on Polkadot Hub Overview](/polkadot-mkdocs/reference/polkadot-hub/assets/){target=\_blank} page, Polkadot Hub accommodates two types of assets: local and foreign. Local assets are those that were created in Polkadot Hub and are identifiable by an integer ID. On the other hand, foreign assets originate from a sibling parachain and are identified by a Multilocation.
...
For an in-depth explanation about Polkadot Hub and its features, see the [Polkadot Hub](/polkadot-mkdocs/chain-interactions/token-operations/convert-assets/){target=\_blank} entry in the Polkadot Wiki.

## Test Setup Environment

You can set up a local parachain environment to test the asset registration process before deploying it on the live network. This guide uses Chopsticks to simulate that process. For further information on chopsticks usage, refer to the [Chopsticks](/polkadot-mkdocs/parachains/testing/fork-a-parachain/){target=\_blank} documentation.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-launch-a-parachain-set-up-the-parachain-template.md
...
- Completed the [Install Polkadot SDK](/polkadot-mkdocs/parachains/install-polkadot-sdk/){target=\_blank} guide and successfully installed [Rust](https://rust-lang.org/){target=\_blank} and the required packages to set up your development environment.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook.md
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-overview.md
...
- Word Count: 592; Token Estimate: 945
...
Both backends share the same RPC interface and tooling support, allowing seamless transitions. In addition, smart contracts can interact with Polkadot native services via [precompile contracts](/polkadot-mkdocs/smart-contracts/precompiles/){target=\_blank}.
...
Furthermore, all smart contracts in Polkadot Hub can interact with any service in the Polkadot ecosystem through [XCM](/polkadot-mkdocs/smart-contracts/precompiles/xcm/){target=\_blank}, enabling token transfers, remote execution, and cross-chain composability without bridges or intermediaries.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference.md
...
- Word Count: 984; Token Estimate: 1775
...
Polkadot is a multi-chain network that enables diverse, interconnected blockchains to share security and communicate seamlessly. Understanding how these components interact from the [relay chain](/polkadot-mkdocs/reference/glossary#relay-chain){target=\_blank} that validates [parachains](/polkadot-mkdocs/reference/glossary#parachain){target=\_blank} to the [governance](/polkadot-mkdocs/reference/glossary#governance){target=\_blank} mechanisms that evolve the protocol is essential for developers, validators, and network participants.
...
[Polkadot Hub](/polkadot-mkdocs/reference/polkadot-hub/){target=\_blank} is the entry point to Polkadot for all users and application developers. It provides access to essential Web3 services including smart contracts, asset management, staking, governance, identity management, and cross-ecosystem interoperability—without requiring you to deploy or manage a parachain.
...
[Parachains](/polkadot-mkdocs/reference/parachains/){target=\_blank} are specialized blockchains that connect to the Polkadot relay chain, inheriting its security while maintaining their own application-specific logic. The parachains documentation covers:
...
- **Interoperability**: Discover [Cross-Consensus Messaging (XCM)](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank}, the standard for cross-chain communication.
...
[On-Chain governance](/polkadot-mkdocs/reference/governance/){target=\_blank} is the decentralized decision-making mechanism for the Polkadot network. It manages the evolution and modification of the network's runtime logic, enabling community oversight and approval for proposed changes. The governance documentation details:
...
The [Glossary](/polkadot-mkdocs/reference/glossary/){target=\_blank} provides quick-reference definitions for Polkadot-specific terminology. Essential terms include:
...
The [Tools](/polkadot-mkdocs/reference/tools/){target=\_blank} section documents essential development and interaction tools for the Polkadot ecosystem:

- **Light clients**: Lightweight solutions for interacting with the network without running full nodes.
- **JavaScript/TypeScript tools**: Libraries like [Polkadot.js API](/polkadot-mkdocs/reference/tools/polkadot-js-api/){target=\_blank} and [PAPI](/polkadot-mkdocs/reference/tools/papi/){target=\_blank} for building applications.
- **Rust tools**: [Polkadart](/polkadot-mkdocs/reference/tools/polkadart/){target=\_blank} and other Rust-based libraries for SDK development.
- **Python tools**: [py-substrate-interface](/polkadot-mkdocs/reference/tools/py-substrate-interface/){target=\_blank} for Python developers.
- **Testing and development**: Tools like [Moonwall](/polkadot-mkdocs/reference/tools/moonwall/){target=\_blank}, [Chopsticks](/polkadot-mkdocs/reference/tools/chopsticks/){target=\_blank}, and [Omninode](/polkadot-mkdocs/reference/tools/omninode/){target=\_blank} for smart contract and parachain testing.
- **Indexing and monitoring**: [Sidecar](/polkadot-mkdocs/reference/tools/sidecar/){target=\_blank} for data indexing and [Dedot](/polkadot-mkdocs/reference/tools/dedot/){target=\_blank} for substrate interaction.
- **Cross-chain tools**: [ParaSpell](/polkadot-mkdocs/reference/tools/paraspell/){target=\_blank} for XCM integration and asset transfers.
...
- <span class="badge guide">Guide</span> **Tools**
    ...
    [:octicons-arrow-right-24: Reference](/polkadot-mkdocs/reference/tools/)
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-blocks-transactions-fees-transactions.md
...
- Word Count: 3335; Token Estimate: 4714
...
![Transaction lifecycle diagram](/polkadot-mkdocs/images/reference/parachains/blocks-transactions-fees/transactions/transactions-01.webp){ style="background:white" }
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-for-eth-devs-blocks-transactions-fees.md
...
- Word Count: 755; Token Estimate: 1159
...
The system provides a fundamental [`eth_transact`](https://paritytech.github.io/polkadot-sdk/master/pallet_revive/pallet/dispatchables/fn.eth_transact.html){target=\_blank} interface for processing raw EVM transactions dispatched through [Ethereum JSON-RPC APIs](/polkadot-mkdocs/smart-contracts/for-eth-devs/json-rpc-apis/){target=\_blank}. This interface acts as a wrapper for Ethereum transactions, requiring an encoded signed transaction payload, though it cannot be dispatched directly. Building upon this foundation, the system supports multiple transaction formats to accommodate different use cases and optimization needs:
...
These resources can be limited at both transaction and contract levels, similar to Ethereum's gas limits. For more information, check the [Gas Model](/polkadot-mkdocs/smart-contracts/for-eth-devs/gas-model/){target=\_blank} documentation.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-blocks-transactions-fees-fees.md
...
- Word Count: 2920; Token Estimate: 4475
...
[Weights](/polkadot-mkdocs/reference/glossary/#weight){target=\_blank} manage the time it takes to validate a block and characterize the time it takes to execute the calls in the block's body. By controlling the execution time a block can consume, weights set limits on storage input, output, and computation.
...
The [Transaction Payment pallet](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/transaction-payment){target=\_blank} provides the basic logic for calculating the inclusion fee. You can also use the Transaction Payment pallet to:
...
- Limits enable you to enforce constant or configurable limits on specific operations. For example, the default [Staking pallet](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/staking){target=\_blank} only allows nominators to nominate 16 validators to limit the complexity of the validator election process.
...
- [Custom weights for the Example pallet](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512/substrate/frame/examples/basic/src/weights.rs){target=\_blank}
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-dev-environments-hardhat-polkadot.md
...
- Word Count: 1267; Token Estimate: 2276
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-dev-environments-hardhat.md
...
- Word Count: 652; Token Estimate: 1158
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-dev-environments-remix.md
...
- Word Count: 608; Token Estimate: 1010
...
- MetaMask connected to Polkadot (see the [Wallet Integrations](/polkadot-mkdocs/smart-contracts/integrations/wallets/#metamask){target=\_blank} guide for setup steps)
...
1. Switch your MetaMask network to Polkadot. For detailed steps on setting up MetaMask for Polkadot, see the [Wallet Integrations](/polkadot-mkdocs/smart-contracts/integrations/wallets/#metamask){target=\_blank} guide.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-libraries-viem.md
...
- Word Count: 1982; Token Estimate: 4127
...
Ensure to replace `INSERT_RPC_URL`, `INSERT_CHAIN_ID`, `INSERT_CHAIN_NAME`, `INSERT_NETWORK_NAME`, `INSERT_CHAIN_DECIMALS`, `INSERT_CURRENCY_NAME`, and `INSERT_CURRENCY_SYMBOL` with the proper values. Check the [Connect to Polkadot](/polkadot-mkdocs/smart-contracts/connect/){target=\_blank} page for more information on the possible values.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-libraries-wagmi.md
...
- Word Count: 1489; Token Estimate: 3245
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-integrations-wallets.md
...
- Word Count: 651; Token Estimate: 1024
...
1. Open the MetaMask extension and click on the network dropdown to switch to the Polkadot Hub TestNet.
    ...
    ![](/polkadot-mkdocs/images/smart-contracts/integrations/wallets/wallets-1.webp){: .browser-extension}

2. Click on the **Custom** tab.

    ![](/polkadot-mkdocs/images/smart-contracts/integrations/wallets/wallets-2.webp){: .browser-extension}

3. Click on the **Add a custom network** button.

    ![](/polkadot-mkdocs/images/smart-contracts/integrations/wallets/wallets-3.webp){: .browser-extension}

4. Complete the necessary fields, then click the **Save** button (refer to the [Networks](/polkadot-mkdocs/smart-contracts/connect/#networks-details){target=\_blank} section for copy and paste parameters).

    ![](/polkadot-mkdocs/images/smart-contracts/integrations/wallets/wallets-3.webp){: .browser-extension}

5. Click on **Polkadot Hub TestNet** to switch the network.

    ![](/polkadot-mkdocs/images/smart-contracts/integrations/wallets/wallets-4.webp){: .browser-extension}
...
2. Once installed, click on the Talisman icon in your browser extensions and click on the **More** button.
    ...
    ![](/polkadot-mkdocs/images/smart-contracts/integrations/wallets/wallets-5.webp){: .browser-extension}

3. Click the button **Manage Networks**.

    ![](/polkadot-mkdocs/images/smart-contracts/integrations/wallets/wallets-6.webp){: .browser-extension}
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-libraries-web3-py.md
...
- Word Count: 1659; Token Estimate: 2979
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-xcm-tools.md
...
- Word Count: 866; Token Estimate: 1405

# XCM Tools

## Introduction

As described in the [Interoperability](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank} section, XCM (Cross-Consensus Messaging) is a protocol used in the Polkadot and Kusama ecosystems to enable communication and interaction between chains. It facilitates cross-chain communication, allowing assets, data, and messages to flow seamlessly across the ecosystem.
...
The Chopsticks library provides XCM functionality for testing XCM messages across networks, enabling you to fork multiple parachains along with a relay chain. For further details, see the [Replay and Dry Run XCMs using Chopsticks](/polkadot-mkdocs/chain-interactions/send-transactions/interoperability/debug-and-preview-xcms/){target=\_blank} guide.
