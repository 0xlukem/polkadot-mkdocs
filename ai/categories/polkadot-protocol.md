...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-consensus-and-security-agile-coretime.md
...
- Word Count: 452; Token Estimate: 622
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-consensus-async-backing.md
...
- Word Count: 1002; Token Estimate: 1814
...
Technically, async backing is a parachain [configuration](https://paritytech.github.io/polkadot-sdk/master/cumulus_primitives_core/relay_chain/struct.AsyncBackingParams.html){target=\_blank} that allows collators and validators to build blocks ahead of the relay chain during the generation and backing stages of the [Inclusion Pipeline](/polkadot-mkdocs/reference/parachains/consensus/inclusion-pipeline){target=\_blank} by using unincluded segments, which are chains of parachain blocks that have not yet been fully included in the relay chain. This decouples parachain block production from relay chain inclusion, improves coretime efficiency, and enables the parallel processing required for parachains to further scale throughput using [Elastic Scaling](/polkadot-mkdocs/reference/parachains/consensus/elastic-scaling){target=\_blank}.
...
The modern protocol now uses asynchronous backing, where both collators and validators have access to [unincluded segments](/polkadot-mkdocs/reference/parachains/consensus/inclusion-pipeline){target=\_blank} as an additional context source. The Backing and Generation steps are no longer coupled to the prior block completing the full inclusion pipeline. Instead, the prior parablock only needs to complete the generation step and be added to the Unincluded Segments before the next parablock can begin the Backing and Generation steps.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-bridging.md
...
To view the complete list of which pallets are included in Bridge Hub, visit the Subscan [Runtime Modules](https://bridgehub-polkadot.subscan.io/runtime){target=\_blank} page. Alternatively, the source code for those pallets can be found in the Polkadot SDK [Snowbridge Pallets](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/bridges/snowbridge/pallets){target=\_blank} repository.
...
- Go over the Bridge Hub README in the Polkadot SDK [Bridge-hub Parachains](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512/cumulus/parachains/runtimes/bridge-hubs/README.md){target=\_blank} repository.
- Take a deeper dive into bridging architecture in the Polkadot SDK [High-Level Bridge](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512/bridges/docs/high-level-overview.md){target=\_blank} documentation.
- Read more about [BEEFY and Bridging in the Polkadot Wiki](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/#bridging-beefy){target=\_blank}.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-collectives-and-daos.md
...
- Word Count: 292; Token Estimate: 423
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-consensus-elastic-scaling.md
...
- Word Count: 1050; Token Estimate: 1450
...
This technical advancement enables parachains to process multiple blocks within a single relay chain block, significantly increasing throughput capabilities. By leveraging [Agile Coretime](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/agile-coretime/){target=\_blank}, parachains can dynamically adjust their processing capacity based on demand, creating an efficient and responsive infrastructure for high-throughput applications.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-consensus-inclusion-pipeline.md
...
- Word Count: 583; Token Estimate: 862
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-governance-origins-tracks.md
...
- Word Count: 469; Token Estimate: 635
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-people-and-identity.md
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-assets.md
...
- Word Count: 1194; Token Estimate: 1748
...
If a balance falls below the configured minimum, called the [existential deposit](/polkadot-mkdocs/reference/glossary/#existential-deposit){target=\_blank}, it may be removed as “dust.” This ensures efficient storage while giving developers control over asset economics.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-smart-contracts.md
...
- Word Count: 456; Token Estimate: 666
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-polkadot-hub-consensus-and-security-pos-consensus.md
...
- **Randomized block production**: Validators enter a lottery to determine which will produce a block in a specific slot. This randomness is sourced from the relay chain's [randomness cycle](/polkadot-mkdocs/reference/parachains/randomness/){target=\_blank}.
...
- **No validators in a slot**: On occasions when no validator is selected by the lottery, a secondary validator selection algorithm steps in. This backup ensures that a block is still produced, preventing skipped slots. However, if the primary block produced by a verifiable random function [(VRF)-selected](/polkadot-mkdocs/reference/parachains/randomness/#vrf){target=\_blank} validator exists for that slot, the secondary block will be ignored. As a result, every slot will have either a primary or a secondary block.
...
- [GRANDPA Pallet](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512/substrate/frame/grandpa/src/lib.rs){target=\_blank}
