...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-chopsticks.md
...
- Word Count: 2074; Token Estimate: 4025
...
=== "Via Polkadot.js API"
    ...
    For programmatic interaction, you can use the [Polkadot.js](/polkadot-mkdocs/reference/tools/polkadot-js-api/){target=\_blank} library:
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-dedot.md
...
- Word Count: 1100; Token Estimate: 2302
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-eth-dapps-uniswap-v2.md
...
- Word Count: 1444; Token Estimate: 2498
...
- Familiarity with [Hardhat](/polkadot-mkdocs/smart-contracts/dev-environments/hardhat/){target=\_blank} development environment.
...
1. Run the local `revive-dev-node`, for this, you can check the [Local Development Node](/polkadot-mkdocs/smart-contracts/dev-environments/local-dev-node/){target=\_blank} guide.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-moonwall.md
...
- Word Count: 1295; Token Estimate: 2458
...
!!! tip
    This documentation corresponds to Moonwall version `5.18.2`. To avoid compatibility issues with the documented features, ensure you're using the matching version.
...
=== "npm"
    ...
    ```bash
    npm install -g @moonwall/cli@5.18.2
    ```

=== "pnpm"

    ```bash
    pnpm -g install @moonwall/cli@5.18.2
    ```

=== "yarn"

    ```bash
    yarn global add @moonwall/cli@5.18.2
    ```
...
=== "npm"
    ...
    ```bash
    npm install @moonwall/cli@5.18.2
    ```

=== "pnpm"

    ```bash
    pnpm install @moonwall/cli@5.18.2
    ```

=== "yarn"

    ```bash
    yarn add @moonwall/cli@5.18.2
    ```
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-testing-fork-a-parachain.md
...
- Word Count: 1328; Token Estimate: 2610
...
You can install Chopsticks globally or locally in your project. Choose the option that best fits your development workflow. This documentation explains the features of Chopsticks version `1.2.5`. Make sure you're using the correct version to match these instructions.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-integrations-indexers.md
...
- Word Count: 302; Token Estimate: 430
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-light-clients.md
...
- Word Count: 849; Token Estimate: 1380
...
Light clients can quickly verify the blockchain's state, including [GRANDPA finality](/polkadot-mkdocs/reference/glossary#grandpa){target=\_blank} justifications.
...
Another common method of communication between a user interface (UI) and a node is through the JSON-RPC protocol. Generally, the UI retrieves information from the node, fetches network or [pallet](/polkadot-mkdocs/reference/glossary#pallet){target=\_blank} data, and interacts with the blockchain. This is typically done in one of two ways:
...
The [Polkadot API (PAPI)](/polkadot-mkdocs/reference/tools/papi/){target=\_blank} library natively supports light client configurations powered by [`smoldot`](https://github.com/smol-dot/smoldot){target=\_blank}. This allows developers to connect to multiple chains simultaneously using a light client.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-integrations-oracles.md
...
- Word Count: 181; Token Estimate: 247
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-polkadart.md
...
- Word Count: 622; Token Estimate: 1161
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-omninode.md
...
- Word Count: 1171; Token Estimate: 2035

# Polkadot Omni Node

## Introduction

The [`polkadot-omni-node`](https://crates.io/crates/polkadot-omni-node/0.7.0){target=\_blank} crate is a versatile, pre-built binary designed to simplify running parachains in the Polkadot ecosystem. Unlike traditional node binaries that are tightly coupled to specific runtime code, the `polkadot-omni-node` operates using an external [chain specification](/polkadot-mkdocs/reference/glossary#chain-specification){target=\_blank} file, allowing it to adapt dynamically to different parachains.
...
- Custom scripts using compatible [libraries](/polkadot-mkdocs/chain-interactions/#development-tools-and-sdks){target=\_blank}.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-papi.md
...
- Word Count: 1156; Token Estimate: 1991
...
=== "npm"
    ...
    ```bash
    npm i polkadot-api@1.23.2
    ```

=== "pnpm"

    ```bash
    pnpm add polkadot-api@1.23.2
    ```

=== "yarn"

    ```bash
    yarn add polkadot-api@1.23.2
    ```
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-polkadot-js-api.md
...
- Word Count: 684; Token Estimate: 1266

# Polkadot.js API

!!! warning "Maintenance Mode Only"
    The Polkadot.js API is now in maintenance mode and is no longer actively developed. New projects should use [Dedot](/polkadot-mkdocs/reference/tools/dedot/){target=\_blank} (TypeScript-first API) or [Polkadot API](/polkadot-mkdocs/reference/tools/papi/){target=\_blank} (modern, type-safe API) as actively maintained alternatives.
...
To add the Polkadot.js API to your project, use the following command to install the version `16.5.4` which supports any Polkadot SDK-based chain:

=== "npm"
    ```bash
    npm i @polkadot/api@16.5.4
    ```

=== "pnpm"
    ```bash
    pnpm add @polkadot/api@16.5.4
    ```

=== "yarn"
    ```bash
    yarn add @polkadot/api@16.5.4
    ```
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-py-substrate-interface.md
...
- Word Count: 541; Token Estimate: 946
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-pop-cli.md
...
- Word Count: 609; Token Estimate: 1000
...
To develop and build Polkadot SDK-based chains, preparing your local environment with the necessary tools and dependencies is essential. The [Install Polkadot SDK Dependencies](/polkadot-mkdocs/parachains/install-polkadot-sdk/){target=\_blank} guide walks you through this setup step-by-step.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-testing-run-a-parachain-network.md
...
- Word Count: 4546; Token Estimate: 9770
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-sidecar.md
...
- Word Count: 1033; Token Estimate: 1948
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-subxt.md
...
- Word Count: 1175; Token Estimate: 2191
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-integrations-wallets.md
...
- Word Count: 489; Token Estimate: 788
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/smart-contracts-cookbook-dapps-zero-to-hero.md
...
- Word Count: 3674; Token Estimate: 7121
...
- A crypto wallet (such as MetaMask) funded with test tokens. Refer to the [Connect to Polkadot](/polkadot-mkdocs/smart-contracts/connect){target=\_blank} guide for more details.
...
For this dApp, you'll use a simple [Storage contract](/polkadot-mkdocs/smart-contracts/cookbook/smart-contracts/deploy-basic/basic-hardhat/#create-the-contract){target=\_blank} that's already deployed in the Polkadot Hub TestNet: `0xc01Ee7f10EA4aF4673cFff62710E1D7792aBa8f3`. To interact with it, you need to define the contract interface.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-tools-zombienet.md
...
- Word Count: 1174; Token Estimate: 2394
