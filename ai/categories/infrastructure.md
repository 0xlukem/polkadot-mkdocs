...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-operational-tasks-general-management.md
...
- Word Count: 3826; Token Estimate: 6757
...
- **Generate and store in node**: Using the `author.rotateKeys` RPC call. For most users, generating keys directly within the client is recommended. You must submit a session certificate from your staking proxy to register new keys. See the [How to Validate](/polkadot-mkdocs/node-infrastructure/run-a-validator/onboarding-and-offboarding/set-up-validator/){target=\_blank} guide for instructions on setting keys.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure.md
...
- Word Count: 548; Token Estimate: 863
...
- **Participate in consensus**: Run [BABE](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/#block-production-babe){target=\_blank} and [GRANDPA](/polkadot-mkdocs/reference/polkadot-hub/consensus-and-security/pos-consensus/#finality-gadget-grandpa){target=\_blank} protocols.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-staking-mechanics-offenses-and-slashes.md
...
- Word Count: 2103; Token Estimate: 3413
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-operational-tasks-pause-validating.md
...
- Word Count: 679; Token Estimate: 864
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-staking-mechanics-rewards.md
...
- Word Count: 1747; Token Estimate: 2572
...
- Issuing validity statements for [parachain blocks](/polkadot-mkdocs/reference/parachains/blocks-transactions-fees/blocks/){target=\_blank}.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-collator.md
...
- Word Count: 2666; Token Estimate: 5096
...
=== "Docker"
    ...
    1. Pull the Polkadot Parachain Docker image using the latest stable tag on [Docker Hub](https://hub.docker.com/r/parity/polkadot-parachain/tags){target=\_blank}:
        ...
        ```bash
        docker pull parity/polkadot-parachain:stable2512
        ```

    2. Verify the installation:

        ```bash
        docker run --rm parity/polkadot-parachain:stable2512 --version
        ```
...
=== "systemd"
    ...
    1. Download the `polkadot-parachain` binary using the latest stable [Polkadot SDK release](https://github.com/paritytech/polkadot-sdk/releases){target=\_blank}:
        ...
        ```bash
        wget https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512/polkadot-parachain
        ```
...
=== "Docker"
    ...
    2. Launch the collator using Docker:
        ...
        docker run -d --name polkadot-collator --restart unless-stopped \
          ...
          parity/polkadot-parachain:stable2512 \
          --collator \
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-node-parachain-rpc.md
...
- Word Count: 2062; Token Estimate: 4195
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-node-polkadot-hub-rpc.md
...
- Word Count: 2584; Token Estimate: 5194

# Run an RPC Node for Polkadot Hub

## Introduction

[Polkadot Hub](/polkadot-mkdocs/reference/polkadot-hub/){target=\_blank} is the gateway to the Polkadot network, providing access to core services such as asset management, governance, and cross-chain messaging. Running your own RPC node gives developers and applications direct access to these services while also supporting infrastructure tasks like block indexing and SDK tool compatibility.
...
To verify the Ethereum RPC adapter is working correctly, you can test standard Ethereum JSON-RPC methods like `eth_chainId`, `eth_blockNumber`, and `eth_getBlockByNumber`. For a complete list of supported methods and example queries, see the [JSON-RPC APIs](/polkadot-mkdocs/smart-contracts/for-eth-devs/json-rpc-apis/){target=\_blank} reference.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-node-relay-chain-bootnode.md
...
- Word Count: 647; Token Estimate: 1049
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-node-relay-chain-full-node.md
...
- Word Count: 2491; Token Estimate: 4225
...
- [Install the necessary dependencies for the Polkadot SDK](/polkadot-mkdocs/parachains/install-polkadot-sdk/){target=\_blank}.

!!! warning
    This setup is not recommended for validators. If you plan to run a validator, refer to the [Running a Validator](/polkadot-mkdocs/node-infrastructure/run-a-validator/onboarding-and-offboarding/set-up-validator/){target=\_blank} guide for proper instructions.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-onboarding-and-offboarding-set-up-validator.md
...
- Word Count: 1676; Token Estimate: 2593
...
- Read [Validator Requirements](/polkadot-mkdocs/node-infrastructure/run-a-validator/requirements/){target=\_blank} and understand the recommended minimum skill level and hardware needs.
- Read [General Management](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/general-management/){target=\_blank}, [Upgrade Your Node](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/upgrade-your-node/){target=\_blank}, and [Pause Validating](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/pause-validating/){target=\_blank} and understand the tasks required to keep your validator operational.
- Read [Rewards Payout](/polkadot-mkdocs/node-infrastructure/run-a-validator/staking-mechanics/rewards/){target=\_blank} and understand how validator rewards are determined and paid out.
- Read [Offenses and Slashes](/polkadot-mkdocs/node-infrastructure/run-a-validator/staking-mechanics/offenses-and-slashes/){target=\_blank} and understand how validator performance and security can affect tokens staked by you or your nominators.
...
=== "`polkadot`"
    ...
    ``` bash
    # Download the binary
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512/polkadot

    # Verify signature
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512/polkadot.asc
...
=== "`polkadot-prepare-worker`"
    ...
    ``` bash
    # Download the binary
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512/polkadot-prepare-worker

    # Verify signature
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512/polkadot-prepare-worker.asc
...
=== "`polkadot-execute-worker`"
    ...
    ``` bash
    # Download the binary
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512/polkadot-execute-worker

    # Verify signature
    curl -LO https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512/polkadot-execute-worker.asc
...
```bash
docker pull parity/polkadot:stable2512
```

### Build from Sources

You may build the binaries from source by following the instructions on the [Polkadot SDK repository](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/polkadot#building){target=\_blank}.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-node-relay-chain-secure-wss.md
...
- Word Count: 775; Token Estimate: 1287
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-onboarding-and-offboarding-start-validating.md
...
- Word Count: 2448; Token Estimate: 3861
...
- Confirm your system meets the [requirements](/polkadot-mkdocs/node-infrastructure/run-a-validator/requirements/){target=\_blank} for running a validator.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-onboarding-and-offboarding-stop-validating.md
...
- Word Count: 501; Token Estimate: 634
...
Use the `staking.chill` extrinsic to initiate this. For more guidance on chilling your node, refer to the [Pause Validating](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/pause-validating/){target=\_blank} guide. You may also claim any pending staking rewards at this point.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-operational-tasks-upgrade-your-node.md
...
- Word Count: 854; Token Estimate: 1196
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-onboarding-and-offboarding-key-management.md
...
- Word Count: 1186; Token Estimate: 1849
...
![](/polkadot-mkdocs/images/node-infrastructure/run-a-validator/onboarding-and-offboarding/key-management/key-management-02.webp)
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/node-infrastructure-run-a-validator-requirements.md
...
- Word Count: 946; Token Estimate: 1492
...
- **Security**: Ensure your setup follows best practices for securing your node. Refer to the [Secure Your Validator](/polkadot-mkdocs/node-infrastructure/run-a-validator/operational-tasks/general-management/#secure-your-validator){target=\_blank} section to learn about important security measures.
- **Network choice**: Start with [Kusama](/polkadot-mkdocs/node-infrastructure/run-a-validator/onboarding-and-offboarding/set-up-validator/#run-a-kusama-validator){target=\_blank} to gain experience. Look for "Adjustments for Kusama" throughout these guides for tips on adapting the provided instructions for the Kusama network.
