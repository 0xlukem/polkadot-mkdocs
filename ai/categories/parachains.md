...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime-add-existing-pallets.md
...
- Word Count: 1592; Token Estimate: 2746
...
- [Polkadot SDK dependencies installed](/polkadot-mkdocs/parachains/install-polkadot-sdk/){target=\_blank}
- A working [Polkadot SDK development environment](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/){target=\_blank}
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime-add-pallet-instances.md
...
- Word Count: 2261; Token Estimate: 3972
...
- A working [Polkadot SDK development environment](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/){target=\_blank}.
- Basic understanding of [adding pallets to a runtime](/polkadot-mkdocs/parachains/customize-runtime/add-existing-pallets/){target=\_blank}.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime-add-smart-contract-functionality.md
...
- Word Count: 835; Token Estimate: 1651
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime-pallet-development-benchmark-pallet.md
...
- Word Count: 2429; Token Estimate: 4500
...
- Familiarity setting up the Polkadot Omni Node and [Polkadot Chain Spec Builder](https://crates.io/crates/staging-chain-spec-builder){target=\_blank}. Refer to the [Set Up a Parachain Template](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/){target=\_blank} guide for instructions if needed.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime-pallet-development-create-a-pallet.md
...
- Word Count: 3261; Token Estimate: 6525
...
- [Polkadot SDK dependencies installed](/polkadot-mkdocs/parachains/install-polkadot-sdk/){target=\_blank}.
- A [Polkadot SDK Parchain Template](/polkadot-mkdocs/parachains/launch-a-parachain/set-up-the-parachain-template/){target=\_blank} set up locally.
- Basic familiarity with [FRAME concepts](/polkadot-mkdocs/parachains/customize-runtime/){target=\_blank}.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-launch-a-parachain-deploy-to-polkadot.md
...
- Word Count: 2381; Token Estimate: 4174
...
Polkadot SDK-based parachains are defined by a file called the [chain specification](/polkadot-mkdocs/reference/glossary/#chain-specification){target=\_blank}, or chain spec for short. There are two types of chain spec files:
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime-pallet-development-mock-runtime.md
...
- Word Count: 1375; Token Estimate: 2530
...
In this guide, you'll learn how to create a mock runtime for the custom counter pallet built in the [Make a Custom Pallet](/polkadot-mkdocs/parachains/customize-runtime/pallet-development/create-a-pallet/){target=\_blank} guide. This mock runtime will enable you to write comprehensive unit tests that verify:
...
- Completed the [Make a Custom Pallet](/polkadot-mkdocs/parachains/customize-runtime/pallet-development/create-a-pallet/){target=\_blank} guide.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-launch-a-parachain-obtain-coretime.md
...
- Word Count: 1353; Token Estimate: 2122
...
If you haven't completed these prerequisites, start by referring to the [Deploy on Polkadot](/polkadot-mkdocs/parachains/launch-a-parachain/deploy-to-polkadot/){target=\_blank} tutorial.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-interoperability-channels-between-parachains.md
...
- Word Count: 1571; Token Estimate: 2335
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-interoperability-channels-with-system-parachains.md
...
- Word Count: 901; Token Estimate: 1458
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/reference-parachains-consensus.md
...
- Word Count: 879; Token Estimate: 1311
...
Parachain consensus operates in tandem with the relay chain, leveraging [Nominated Proof of Stake (NPoS)](/polkadot-mkdocs/reference/glossary/#nominated-proof-of-stake-npos){target=\_blank} for shared security. The process ensures parachain transactions achieve finality through the following steps:
...
-   <span class="badge learn">Learn</span> __Elastic Scaling__
    ...
    [:octicons-arrow-right-24: Elastic Scaling](/polkadot-mkdocs/reference/parachains/consensus/elastic-scaling/){target=\_blank}
...
-   <span class="badge learn">Learn</span> __Asynchronous Backing__
    ...
    [:octicons-arrow-right-24: Asynchronous Backing](/polkadot-mkdocs/reference/parachains/consensus/async-backing/){target=\_blank}
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-runtime-maintenance-runtime-upgrades.md
...
- Word Count: 813; Token Estimate: 1168
...
For detailed guidance, scenarios, and implementation patterns, see the [Storage Migrations](/polkadot-mkdocs/parachains/runtime-maintenance/storage-migrations/){target=\_blank} page.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-runtime-maintenance-storage-migrations.md
...
- Word Count: 2310; Token Estimate: 3927
...
For a complete implementation example of multi-block migrations, refer to the [official example](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512/substrate/frame/examples/multi-block-migrations){target=\_blank} in the Polkadot SDK.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-customize-runtime-pallet-development-pallet-testing.md
...
- Word Count: 2558; Token Estimate: 5720
...
[FRAME (Framework for Runtime Aggregation of Modularized Entities)](/polkadot-mkdocs/reference/glossary/#frame-framework-for-runtime-aggregation-of-modularized-entities){target=\_blank} provides specialized testing macros and utilities that make pallet testing more efficient.
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-runtime-maintenance-unlock-parachains.md
...
- Word Count: 1296; Token Estimate: 2073
...
This document guides you through checking a parachain's lock status and safely executing the unlock procedure from a parachain using [XCM (Cross-Consensus Messaging)](/polkadot-mkdocs/parachains/interoperability/get-started/){target=\_blank}.
...
=== "Manual Calculation"
    ...
    2. Encode your parachain ID as a u32 [SCALE](/polkadot-mkdocs/reference/parachains/data-encoding/#data-types){target=\_blank} value:
